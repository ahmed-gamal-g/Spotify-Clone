...
const songs = [
  ...
  {
    id: "17",
    songName: `Batao Yaad Hai Tumko Wo Jab Dil ko Charaya The  <br><div class="subtitle">Rahat Fateh Ali</div>`,
    poster: "img/17.jpg",
  },
  {
    id: "18",
  ...
  {
    id: "19",
    songName: `Eh Munde Pagel Ne Saare <br><div class="subtitle">Ap Dhillon, Gurinder Gill, Shinda Kahlon</div>`,
    poster: "img/19.jpg",
  },
  {
    id: "20",
...
let po_art_left = document.getElementById("po_art_left");
let po_art_right = document.getElementById("po_art_right");
let item = document.getElementsByClassName("item")[0];

po_art_right.addEventListener("click", () => {
  item.scrollLeft += 100;
});

po_art_left.addEventListener("click", () => {
  item.scrollLeft -= 100;
});
